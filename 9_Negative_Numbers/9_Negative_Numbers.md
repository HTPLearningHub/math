...
<p align="center">
    <img
      src="./assets/fig_01_below_zero.png"
      width="960"
      alt="Three vertical scales, each with a dashed line at zero and an orange marker below it: a thermometer at minus five degrees, a bank balance of minus ten, and a depth of minus three metres"
      />
</p>
...
<p align="center">
    <img
      src="./assets/fig_02_number_line.png"
      width="980"
      alt="A number line from minus six to six, with the negative half shaded orange on the left, the positive half shaded blue on the right, zero in grey in the middle, and an arrow along the bottom running from smaller on the left to larger on the right"
      />
</p>
...
<p align="center">
    <img
      src="./assets/fig_03_opposites.png"
      width="960"
      alt="A number line with minus five marked in orange and five marked in blue, and two measuring arrows of equal length running from zero out to each of them"
      />
</p>
...
<p align="center">
    <img
      src="./assets/fig_04_comparing.png"
      width="960"
      alt="A number line from minus seven to two with minus five and minus two marked as orange dots, an arrow from minus five to minus two labelled further right so greater, and two boxes below showing the wrong comparison in red and the right one in green"
      />
</p>
...
<p align="center">
    <img
      src="./assets/fig_05_walking.png"
      width="980"
      alt="Two number lines. On the first, a walk of two steps to the left from five down to three. On the second, a walk of nine steps to the right from minus four up to five, crossing zero on the way"
      />
</p>
...
<p align="center">
    <img
      src="./assets/fig_06_subtracting_a_negative.png"
      width="940"
      alt="A number line from minus three to six with a purple bracket spanning the seven steps from minus two to five, split underneath into two steps from minus two to zero and five steps from zero to five"
      />
</p>
...
<p align="center">
    <img
      src="./assets/fig_07_five_times_minus_two.png"
      width="980"
      alt="A number line from minus eleven to one with five orange arrows, each two steps long, taking you from zero down to minus ten"
      />
</p>
...
<p align="center">
    <img
      src="./assets/fig_08_pattern.png"
      width="900"
      alt="Seven multiplications by minus two in a column, with the first number dropping by one each row and the answers climbing by two each row, from minus six up through zero to six"
      />
</p>
...
<p align="center">
    <img
      src="./assets/fig_09_sign_grid.png"
      width="900"
      alt="A two by two grid showing the sign of the answer for each pair of signs when multiplying or dividing, with a red warning bar underneath saying the grid does not apply to addition and subtraction"
      />
</p>
