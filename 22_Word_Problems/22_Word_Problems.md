...
<p align="center">
    <img
      src="./assets/fig_01_the_missing_half.png"
      width="1000"
      alt="Four cards in a row: a story, an equation, a number, an answer. The first and third arrows are orange and labelled this chapter; the middle arrow is blue and labelled Chapters 20 and 21"
      />
</p>
...
<p align="center">
    <img
      src="./assets/fig_02_less_than_turns_round.png"
      width="900"
      alt="The phrase three less than two g, with the reading 3 minus 2g crossed out in red on the left and the reading 2g minus 3 in green on the right, and the number check ten minus three equals seven underneath"
      />
</p>
...
<p align="center">
    <img
      src="./assets/fig_03_two_questions_one_equation.png"
      width="1000"
      alt="The equation s equals 2g minus 3 at the top, with two lanes below it: the upper lane puts g equals 12 in and evaluates to s equals 21, the lower lane puts s equals 21 in and solves to g equals 12"
      />
</p>
...
<p align="center">
    <img
      src="./assets/fig_04_consecutive_multiples.png"
      width="1000"
      alt="Two number lines drawn to the same scale. The upper one has three blue dots at 9, 12 and 15 labelled x, x plus 3 and x plus 6, with plus three hops between them. The lower one has three grey dots crowded at 9, 10 and 11"
      />
</p>
...
<p align="center">
    <img
      src="./assets/fig_05_two_letters_need_two_facts.png"
      width="900"
      alt="A table of r and j pairs that all obey j equals r plus 6, with a third column showing 2r plus 3j for each pair. Only the row r equals 10, j equals 16 reaches 68, and it is highlighted in green"
      />
</p>
...
<p align="center">
    <img
      src="./assets/fig_06_two_kinds_of_check.png"
      width="900"
      alt="Two panels. The left panel, the arithmetic check, shows 2 times 10 plus 3 times 16 equalling 68 with green ticks. The right panel, the sense check, ticks ten spots on a dog and crosses an age of minus four years and 3.5 children in a family"
      />
</p>
