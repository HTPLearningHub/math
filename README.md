...
3. [Geometry Essentials](./notebooks/03-geometry-essentials.ipynb)
4. [Polynomials](./notebooks/04-polynomials.ipynb) 
5. [Factoring Polynomials](./notebooks/05-factoring-polynomials.ipynb)
6. [Synthetic Division](./notebooks/06-synthetic-division.ipynb)
...
1. [Linear Equations](./notebooks/09-linear-equations.ipynb)
...
2. [Graphs of Equations in Two Variables;Intercepts;Symmetry]
3. [Lines]
4. [Circles]
5. [Variation]
