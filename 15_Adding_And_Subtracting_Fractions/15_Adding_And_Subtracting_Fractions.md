...
<p align="center">
    <img
      src="./assets/fig_01_adding_eighths.png"
      width="960"
      alt="Four bars of the same length. The first is cut into eighths with one piece shaded, the second into eighths with three shaded, the third into eighths with four shaded, and the fourth into halves with one shaded"
      />
</p>
...
<p align="center">
    <img
      src="./assets/fig_02_adding_bottoms_is_wrong.png"
      width="960"
      alt="Four bars of the same length showing one third, one quarter, the wrong answer two sevenths, and the correct answer seven twelfths, with a dashed line marking where one third ends"
      />
</p>
...
<p align="center">
    <img
      src="./assets/fig_03_grid_thirds_quarters.png"
      width="960"
      alt="Three rectangles, each divided into three rows and four columns making twelve cells. The first has one row shaded, the second has one column shaded, the third has seven cells shaded"
      />
</p>
...
<p align="center">
    <img
      src="./assets/fig_04_negative_on_the_line.png"
      width="960"
      alt="A number line marked in thirty-fifths. A blue dot sits at ten thirty-fifths, an orange arrow of twenty-one steps goes to the left, and a green dot sits at minus eleven thirty-fifths"
      />
</p>
...
<p align="center">
    <img
      src="./assets/fig_05_the_whole_method.png"
      width="960"
      alt="A flow diagram. A box of two fractions leads to a diamond asking whether the bottom numbers are the same. The no branch goes through finding the least common denominator and rewriting both fractions. Both branches meet at adding the top numbers, then simplifying"
      />
</p>
