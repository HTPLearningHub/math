...
One row per topic. Says where the book explains it first. Read this before writing anything.

| Topic | First explained | Notes |
| --- | --- | --- |
| Division as equal sharing | Ch. 1 § 1.1 | Sweets example, check by multiplying back |
| Dividend, divisor, quotient | Ch. 1 § 1.2 | The three names, used all through Ch. 1 |
| Division that does not come out even | Ch. 1 § 1.3 | One pizza, eight friends; motivates fractions |
| Fraction (definition) | Ch. 1 § 2.1 | Pizza with 8 slices, fig_01 |
| Numerator and denominator | Ch. 1 § 2.1 | Top = parts taken, bottom = parts in one whole |
| Fraction bar means division | Ch. 1 § 2.2 | Key idea of the chapter |
| Whole made of its parts | Ch. 1 § 2.3 | Any number over itself equals 1 |
| Proper fraction | Ch. 1 § 2.4 | Value strictly between 0 and 1 |
| Equivalent fractions | Ch. 1 § 3.1 | 2/8 = 1/4, fig_02 |
| Rule of equivalence | Ch. 1 § 3.2 | Multiply or divide top and bottom by the same number; reused in Ch. 2 § 3.4 |
| Simplifying (reducing) | Ch. 1 § 3.3 | Steps + 2/8 and 6/8 worked out |
| Comparing, same denominator | Ch. 1 § 4.1 | Bigger numerator wins |
| Comparing, same numerator | Ch. 1 § 4.2 | Smaller denominator wins, fig_03 |
| Improper fraction | Ch. 1 § 5.1 | 4/3, fig_04 |
| Mixed number | Ch. 1 § 5.1 | Whole number plus proper fraction; means addition |
| Fractions on the number line | Ch. 1 § 5.2 | fig_05, proper before 1, improper at or after 1 |
| Improper fraction to mixed number | Ch. 1 § 5.3 | Divide, remainder on top, then simplify |
| Mixed number to improper fraction | Ch. 1 § 5.4 | Multiply then add |
| Remainder | Ch. 1 § 5.3 | Introduced inside the conversion steps |
| Rounding up to whole items | Ch. 1 § 6 | Pizza party: order 4, not 3 |
| Why decimals exist | Ch. 2 § 1 | Fractions are correct but slow to calculate with |
| Decimal (definition) | Ch. 2 § 1.2 | Digits and a point, whole part plus part smaller than one |
| Place value | Ch. 2 § 2.1 | 325 broken into 300 + 20 + 5 |
| The rule of ten (base-10 scaling) | Ch. 2 § 2.2 | Left = times 10, right = divide by 10; the reason decimals work |
| Decimal point, decimal place | Ch. 2 § 2.3 | fig_01 place value chart |
| Tenths, hundredths, thousandths | Ch. 2 § 2.3 | With their fractions 1/10, 1/100, 1/1000 |
| Magnitude | Ch. 2 § 2.4 | fig_02; the digit 1 in 100, 1, 0.1, 0.01, 0.001 |
| Mixed number written as a decimal | Ch. 2 § 3.1 | fig_03 pizzas cut into tenths; reading "two point three" |
| Fraction over 10 / 100 / 1000 to a decimal | Ch. 2 § 3.2 | Denominator picks the place |
| Zero as a place holder | Ch. 2 § 3.3 | 0.03 is not 0.3 |
| Trailing zeros | Ch. 2 § 3.4 | 0.5 = 0.50 = 0.500, proved with Ch. 1 § 3.2 |
| Hundredths grid | Ch. 2 § 4.1 | fig_04; shows 0.1 = 0.10 |
| Decimals on the number line | Ch. 2 § 4.2 | fig_05; ten equal steps between whole numbers |
| Comparing decimals | Ch. 2 § 5 | fig_06; compare from the left, or pad with zeros |
