...
<p align="center">
    <img
      src="./assets/fig_01_rows_of_dots.png"
      width="880"
      alt="The same grid of fifteen dots shown twice: on the left it is grouped into five blue rows of three dots, on the right into three orange columns of five dots"
      />
</p>
...
<p align="center">
    <img
      src="./assets/fig_02_apple_piles.png"
      width="880"
      alt="Top: five rows of seven blue apples, labelled 5 times 7 equals 35. Bottom: the same five rows with the first three apples of each row in blue and the last four in orange, labelled 5 times 3 equals 15 plus 5 times 4 equals 20"
      />
</p>
...
<p align="center">
    <img
      src="./assets/fig_03_area_model.png"
      width="880"
      alt="A rectangle five squares tall and thirty-four squares wide, cut by a vertical line into a blue part thirty wide holding 150 squares and an orange part four wide holding 20 squares"
      />
</p>
...
<p align="center">
    <img
      src="./assets/fig_04_forgetting_a_piece.png"
      width="880"
      alt="Two rectangles three tall and nine wide side by side. The left one is fully coloured, twelve squares blue and fifteen orange, total twenty-seven. The right one has twelve blue squares, only five orange squares and ten grey hatched squares labelled never counted, total seventeen"
      />
</p>
...
<p align="center">
    <img
      src="./assets/fig_05_taking_a_strip_away.png"
      width="880"
      alt="A rectangle five squares tall and ten wide. The first eight columns are blue and hold forty squares. The last two columns are grey and hatched and hold ten squares, marked as taken away"
      />
</p>
...
<p align="center">
    <img
      src="./assets/fig_06_place_value_split.png"
      width="880"
      alt="A flow diagram: three boxes holding 300, 40 and 5, each with an arrow labelled times 6 leading down to a second box holding 1800, 240 and 30, joined by plus signs, with the total 2070 written underneath"
      />
</p>
