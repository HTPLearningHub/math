...
<p align="center">
    <img
      src="./assets/fig_01_place_value_chart.png"
      width="820"
      alt="A row of boxes for hundreds, tens, ones, the decimal point, tenths, hundredths and thousandths, with an arrow above showing times ten to the left and an arrow below showing divide by ten to the right"
      />
</p>
...
<p align="center">
    <img
      src="./assets/fig_02_ten_times_smaller.png"
      width="760"
      alt="Four bars of the same length: one whole fully shaded, then one of ten parts shaded, then one of a hundred parts, then one of a thousand parts, each shaded piece much thinner than the one above"
      />
</p>
...
<p align="center">
    <img
      src="./assets/fig_03_pizza_two_point_three.png"
      width="700"
      alt="Three pizzas each cut into ten slices: the first two pizzas are completely blue, the third has three orange slices, above them the equation two and three tenths equals two point three"
      />
</p>
...
<p align="center">
    <img
      src="./assets/fig_04_hundredths_grid.png"
      width="560"
      alt="A large square divided into a ten by ten grid, with one small square shaded orange and one full column of ten squares shaded blue"
      />
</p>
...
<p align="center">
    <img
      src="./assets/fig_05_number_line_tenths.png"
      width="860"
      alt="A number line from zero to two with a tall mark at every whole number and nine short marks between them, with the points 0.1 and 1.1 marked"
      />
</p>
...
<p align="center">
    <img
      src="./assets/fig_06_compare_decimals.png"
      width="800"
      alt="Two bars of the same length, both cut into ten tenths: the top bar has five tenths shaded blue for 0.5, the bottom bar has a small orange piece shorter than two tenths for 0.125"
      />
</p>
...
<p align="center">
    <img
      src="./assets/fig_07_align_decimal_points.png"
      width="880"
      alt="Two panels: on the left, in red, 2.3 and 1.45 with their last digits lined up, so 3 tenths sits above 5 hundredths; on the right, in green, 2.30 and 1.45 with the decimal points lined up and the correct answer 3.75"
      />
</p>
