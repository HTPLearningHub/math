...
<p align="center">
    <img
      src="./assets/fig_01_two_slices.png"
      width="960"
      alt="Four bars of the same length. The first is cut into eighths with one shaded, the second into eighths with two shaded, the third into sixteenths with two shaded, and the fourth into quarters with one shaded"
      />
</p>
...
<p align="center">
    <img
      src="./assets/fig_02_half_of_two_thirds.png"
      width="960"
      alt="Three bars of the same length cut into thirds. The first has two thirds shaded blue, the second has the blue stretch cut in half with the left half orange, the third has one third shaded green"
      />
</p>
...
<p align="center">
    <img
      src="./assets/fig_03_rectangle_model.png"
      width="1000"
      alt="Three squares. The first is cut into three columns with two shaded blue, the second into two rows with one shaded orange, the third has both sets of cuts and two of its six cells are green"
      />
</p>
...
<p align="center">
    <img
      src="./assets/fig_04_reciprocal.png"
      width="960"
      alt="Three pairs of cards joined by crossing arrows, showing three quarters becoming four thirds, one fifth becoming five, and two becoming one half, above a bar of twelve shaded cells"
      />
</p>
...
<p align="center">
    <img
      src="./assets/fig_05_how_many_fit.png"
      width="1000"
      alt="Three whole bars drawn end to end, each cut into four quarters, with the twelve quarters numbered from one to twelve"
      />
</p>
...
<p align="center">
    <img
      src="./assets/fig_06_the_whole_method.png"
      width="960"
      alt="A flow diagram: write whole numbers over one, then ask whether it is a division; if yes, flip the second fraction; then multiply tops and bottoms, simplify, and finish"
      />
</p>
